...
public class GetEquipmentItem : MonoBehaviour
{
    ...
    {
        //Equipment item = new Equipment(itemFromData.Count, itemFromData.MaxCount, itemFromData.BuyPrice, itemFromData.SellPrice, itemFromData.Id, itemFromData.Name, itemFromData.DisplayName, itemFromData.Description, itemFromData.Type, itemFromData.Icon);
