...
public class ItemData : MonoBehaviour
{
    ...
    private void RegisterConsumItem()
    {
        ...
        hp1.UseEvent += (item) => UseItemFunc(hp1);
    ...
    private void RegisterEquipmentItem()
    {
        ...
        sword1.UseEvent += (item) => UseItemFunc(sword1);
        ...
        shoulder1.UseEvent += (item) => UseItemFunc(sword1);
        ...
        bow1.UseEvent += (item) => UseItemFunc(bow1);
    ...
    private void RegisterCommonItem()
    {
        ...
        iron1.UseEvent += (item) => UseItemFunc(iron1);
        ...
        paper1.UseEvent += (item) => UseItemFunc(paper1);
        commonItemList.Add(paper1);

    }

    private void UseItemFunc(SlotItem item)
    {
